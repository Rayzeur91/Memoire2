...
})(window,document,'script','dataLayer','GTM-NXVCGBT9');</script>
<!-- End Google Tag Manager -->
 <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-STCD9BMYSE"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-STCD9BMYSE');
</script>
</head>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart"
        ...
        <div class="offcanvas-body">
            <div class="order-md-last">
                ...
                <a href="checkout.php" class="w-100 btn btn-primary btn-lg">Payé</a>
                <a href="cart.php" class="w-100 btn btn-outline-primary btn-lg mt-3">Voir Mon Pannier</a>
            </div>
        </div>
    </div>
        ...
        <div class="container py-2">
            <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
                ...
                <div class="col-sm-12 col-lg-12 text-center">
                    <div class="main-logo">
                        <a href="index.php">
                            <img src="images/logoYuliAndFriendsBleu.avif" alt="logo" class="img-fluid">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        <li>
                            ...
                            <a href="logout.php" class="mx-1">
                                ...
                                <span class="mx-1">Déconnection</span>
                            </a>
                            <?php else : ?>
                            <a href="account.php" class="mx-1">
                                <iconify-icon icon="mdi:login" class="fs-4"></iconify-icon>
                                <span class="mx-1">Connecxion</span>
                            </a>
                            <a href="account.php" class="mx-1">
                            ...
                            <ul class="d-flex justify-content-end list-unstyled m-0">
                                ...
                                <li>
                                    ...
                                    <a href="profile.php" class="mx-3">
                                        <iconify-icon icon="healthicons:person" class="fs-4"></iconify-icon>
                                        <span class="mx-1">Bienvenue, <?php echo $_SESSION['username']; ?></span>
                                    </a>
